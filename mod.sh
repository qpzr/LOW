...
echo 'sfe设置'
sed -i '/+kmod-tcp-bbr/d' package/lean/luci-app-sfe/Makefile
sed -i '32,35d' package/lean/luci-app-sfe/luasrc/model/cbi/sfe.lua
sed -i '5d;13d;19d' package/lean/luci-app-sfe/luasrc/view/sfe/status.htm
