...
sed -i '57,80d' feeds/luci/applications/luci-app-turboacc/luasrc/model/cbi/turboacc.lua
...
echo '最新design主题'
git clone -b master https://github.com/gngpp/luci-theme-design luci-theme-design
